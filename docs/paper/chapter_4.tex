...
version created for Windows \cite{apple2024}. Due to this, Apple Safari was not chosen as a test browser. The evaluation
utilized identical pairs of articles categorized as fake news or real news. The figures will be divided into four classifiers:
false positive, true positive, false negative, and true negative. Figures \ref{fig:false-positive-chrome-test} and \ref{fig:true-positive-chrome-test}
display the outcomes for false positive and true postive, while figures \ref{fig:false-negative-chrome-test} and \ref{fig:true-negative-chrome-test} shows false negative and true negative result using Google Chrome.
Figures \ref{fig:false-positive-edge-test}, \ref{fig:true-positive-edge-test}, \ref{fig:false-negative-edge-test} and \ref{fig:true-negative-edge-test} display the outcomes for the
false positive, true positive, false negative, and true negative results using Microsoft Edge. Lastly, Figures \ref{fig:false-positive-firefox-test}, \ref{fig:true-positive-firefox-test}, \ref{fig:false-negative-firefox-test} and
\ref{fig:true-negative-firefox-test} display the false positive, true positive, false negative, and true negative outcomes for Mozilla Firefox. The results demonstrated that the application's functionality remained uniform across different browsers.

    \begin{figure}[h!]
        \centering
        \includegraphics[width=1\textwidth,height=1\textheight, keepaspectratio]{figures/Screenshots/chrome-false-positive.png}
            \caption{FaKe Extension testing with Google Chrome (False Positive).}
            \label{fig:false-positive-chrome-test}
        \end{figure}

        \begin{figure}[h!]
            \centering
            \includegraphics[width=1\textwidth,height=1\textheight, keepaspectratio]{figures/Screenshots/chrome-true-positive.png}
                \caption{FaKe Extension testing with Google Chrome (True Positive).}
                \label{fig:true-positive-chrome-test}
            \end{figure}

        \begin{figure}[h!]
            \centering
            \includegraphics[width=1\textwidth,height=1\textheight, keepaspectratio]{figures/Screenshots/chrome-false-negative.png}
                \caption{FaKe Extension testing with Google Chrome (False Negative).}
                \label{fig:false-negative-chrome-test}
            \end{figure}

        \begin{figure}[h!]
            \centering
            \includegraphics[width=1\textwidth,height=1\textheight, keepaspectratio]{figures/Screenshots/chrome-true-negative.png}
                \caption{FaKe Extension testing with Google Chrome (True Negative).}
                \label{fig:true-negative-chrome-test}
            \end{figure}

            \begin{figure}[h!]
                \centering
                \includegraphics[width=1\textwidth,height=1\textheight, keepaspectratio]{figures/Screenshots/edge-false-positive.png}
                    \caption{FaKe Extension testing with Microsoft Edge (False Positive).}
                    \label{fig:false-positive-edge-test}
                \end{figure}

                \begin{figure}[h!]
                    \centering
                    \includegraphics[width=1\textwidth,height=1\textheight, keepaspectratio]{figures/Screenshots/edge-true-positive.png}
                        \caption{FaKe Extension testing with Microsoft Edge (True Positive).}
                        \label{fig:true-positive-edge-test}
                    \end{figure}

            \begin{figure}[h!]
                \centering
                \includegraphics[width=1\textwidth,height=1\textheight, keepaspectratio]{figures/Screenshots/edge-false-negative.png}
                    \caption{FaKe Extension testing with Microsoft Edge (False Negative).}
                    \label{fig:false-negative-edge-test}
                \end{figure}
            \begin{figure}[h!]
                \centering
                \includegraphics[width=1\textwidth,height=1\textheight, keepaspectratio]{figures/Screenshots/edge-true-negative.png}
                    \caption{FaKe Extension testing with Microsoft Edge (True Negative).}
                    \label{fig:true-negative-edge-test}
                \end{figure}

            \begin{figure}[h!]
                \centering
                \includegraphics[width=1\textwidth,height=1\textheight, keepaspectratio]{figures/Screenshots/firefox-false-positive.png}
                    \caption{FaKe Extension testing with Mozilla Firefox (False Positive).}
                    \label{fig:false-positive-firefox-test}
                \end{figure}

                \begin{figure}[h!]
                    \centering
                    \includegraphics[width=1\textwidth,height=1\textheight, keepaspectratio]{figures/Screenshots/firefox-true-positive.png}
                        \caption{FaKe Extension testing with Mozilla Firefox (True Positive).}
                        \label{fig:true-positive-firefox-test}
                    \end{figure}

            \begin{figure}[h!]
                \centering
                \includegraphics[width=1\textwidth,height=1\textheight, keepaspectratio]{figures/Screenshots/firefox-false-negative.png}
                    \caption{FaKe Extension testing with Mozilla Firefox (False Negative).}
                    \label{fig:false-negative-firefox-test}
                \end{figure}

            \begin{figure}[h!]
                \centering
                \includegraphics[width=1\textwidth,height=1\textheight, keepaspectratio]{figures/Screenshots/firefox-true-negative.png}
                    \caption{FaKe Extension testing with Mozilla Firefox (True Negative).}
                    \label{fig:true-negative-firefox-test}
                \end{figure}
                ...
                \begin{figure}[h!]
                    ...
                    \begin{figure}[h!]
                        ...
                        \small \raggedright Ini-report sa pulisya ang pagtangay ng mga suspek sa isang Honda TMX 155 motorized tricycle (8150-ZA) na minamaneho ni Edwin Arzadon y Balat, 36, biyudo, ng lungsod, madaling araw noong Linggo sa Sta. Isabel Subdivision. – Liezle Basa Iñigo\linebreak\linebreak
                          \noindent\rule{0.5\textwidth}{0.4pt}\linebreak\linebreak
                        ...
                        \begin{figure}[h!]
                            ...
                            \small \raggedright -Marivic Awitan
                            \noindent\rule{0.5\textwidth}{0.4pt}\linebreak\linebreak
