...
\pagebreak
\section{App Testing}
The FaKe application was assessed using three prominent browsers - Google Chrome, Microsoft Edge, and Mozilla Firefox. As of 2023, Google Chrome, Safari, Microsoft Edge, and Mozilla Firefox are some of the most popular internet browsers with 63.56\%, 19.84\%, 5.43\%, and 2.95\% respectively \cite{statista2024}. Windows is the most widely used operating system, followed by MacOS and Linux \cite{inproceedings}. The availability of Apple devices for testing the web application is a challenge, limiting the assessment to comprehensively assess cross-platform compatibility. Moreover, Apple Safari no longer offer Safari updates for Windows devices with the 2010 version of Safari being the last version created for Windows \cite{apple2024}. Due to this constraint, Apple Safari was not chosen as a browser to test on. The evaluation utilized identical articles categorized as fake news or real news. Figure \ref{fig:fake-chrome-test} and \ref{fig:real-chrome-test} illustrate the outcomes using Google Chrome,  Figure \ref{fig:fake-edge-test} and \ref{fig:real-edge-test} display the results for Microsoft Edge, and Figure \ref{fig:fake-firefox-test} and \ref{fig:real-firefox-test} show the findings for Mozilla Firefox. The results demonstrate uniformity of the application's functionality through different browsers.
            ...
            \begin{figure}[h!]
                ...
                \begin{figure}[h!]
                    ...
                    \parbox{\textwidth}{% TODO Translate the text properly Italicize the translation
                      Mahaharap sa kasong administratibo ang isang opisyal ng pulisya matapos magwala sa mismong himpilan, pinasok sa opisina ang kanyang hepe at pinagsasalitaan umano ng masama, Lunes ng gabi, sa Bacoor City, Cavite.\linebreak

                      Kasong grave misconduct ang kakaharapin ni Chief Insp. Virgilio Rubio, deputy chief ng Bacoor City Police, batay sa reklamo ni Supt. Rommel Estolano.\linebreak
                      ...
                      Gayunman, naawat ni Senior Insp. Chey Chey Saulog si Rubio at pinalabas sa himpilan ng pulisya.\linebreak\linebreak
                      \noindent\rule{0.5\textwidth}{0.4pt}\linebreak\linebreak

                      Translation:
                      A police officer will face administrative charges after he disappeared from the station, his boss entered the office and allegedly badmouthed him, Monday night, in Bacoor City, Cavite.\linebreak

                      Chief Insp. Virgilio Rubio will face a case of grave misconduct. Virgilio Rubio, deputy chief of the Bacoor City Police, based on the complaint of Supt. Rommel Estolano.\linebreak

                      In a report to the office of Cavite Police Provincial Office director Senior Supt. Joselito Esquivel, around 7:30 in the evening when Rubio went to the police station who was very drunk, suddenly threw chairs and other items in the office until he entered Rubio's office with a gun in his hand and discharged some- what bad words.\linebreak

                      However, Senior Insp. Chey Chey Rubio was arrested and taken out of the police station.\linebreak\linebreak
