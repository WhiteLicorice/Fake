...
display the outcomes for false positive and true postive, while figure \ref{fig:true-negative-chrome-test} shows true negative result using Google Chrome.
Figures \ref{fig:false-positive-edge-test}, \ref{fig:true-positive-edge-test}, and \ref{fig:true-negative-edge-test} display the outcomes for the
false positive, true positive, and true negative results using Microsoft Edge. Lastly, Figures \ref{fig:false-positive-firefox-test}, \ref{fig:true-positive-firefox-test}, and
\ref{fig:true-negative-firefox-test} display the false positive, true positive, and true negative outcomes for Mozilla Firefox. The results demonstrated that the application's functionality remained uniform across different browsers.
