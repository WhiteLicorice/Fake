...
async def load_processors():
    ...
    #with open("root/stopwords-en.json", "r") as en:    ##  stopwords-en.json has corrupt bit, must load manually as array
